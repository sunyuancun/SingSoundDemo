package com.singsound.singsounddemo.utils.tabview;
...
public class TabView extends RelativeLayout {
    ...
    private void initDefaultAttrs(Context context) {
        mTextViewSelColor = Color.parseColor("#e4e4e4");
        mTextViewUnSelColor = Color.parseColor("#3bb2d7");
        mTabViewBackgroundColor = Color.rgb(255, 255, 255);
        mTabViewHeight = TabViewUtil.dp2px(context, 55);
        mImageViewTextViewMargin = TabViewUtil.dp2px(context, 1);
        mTextViewSize = TabViewUtil.sp2px(context, 14);
        mImageViewWidth = TabViewUtil.dp2px(context, 28);
        mImageViewHeight = TabViewUtil.dp2px(context, 28);
...
//        textView_line.setHeight(TabViewUtil.dp2px(context, 1));
        ...
        //// TODO: 2016/9/12   textview   位置仅修改了  mTabViewGravity == Gravity.BOTTOM
        if (mTabViewGravity == Gravity.BOTTOM) {
            ...
            textViewParams.addRule(RelativeLayout.ABOVE, R.id.tabview_id);
            fragmentContainerParams.addRule(RelativeLayout.ABOVE, R.id.tabview_textview);
    ...
    private void initTabChildView() {
        ...
        for (int i = 0; i < mTabViewChildList.size(); i++) {
            ...
            textviewParams.bottomMargin = mImageViewTextViewMargin;
            textview.setLayoutParams(textviewParams);
            tabChild.addView(textview);


            tabview.addView(tabChild, i);
    ...
    public void setTabViewDefaultPosition(int position) {
        ...
        for (int i = 0; i < tabview.getChildCount(); i++) {
            if (i == position) {
                tabview.getChildAt(i).setBackgroundResource(R.mipmap.bottom_selected);
            } else {
                tabview.getChildAt(i).setBackgroundResource(R.mipmap.bottom_unselected);
            }
        }
