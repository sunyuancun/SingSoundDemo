...
public class Sentence_NativeActivity extends BaseNativeActivity implements View.OnClickListener, AudioRecoderUtils.OnAudioStatusUpdateListener, View.OnTouchListener {
    ...
    protected void initContentView(Bundle savedInstanceState) {
        setContentView(R.layout.activity_sentence__native);
        initTitle();
        initUI();
    }
    ...
    private void updateView(JSONObject result) {
        try {
            ...
            mUpdateOffineColorCallBack.UpdateOffineColor(Sentence_NativeActivity.this, mPosition, sentenceDetailList);
