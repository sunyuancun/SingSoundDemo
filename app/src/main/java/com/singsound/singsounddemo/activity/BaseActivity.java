...
import com.singsound.singsounddemo.NetWorkUtils;
 ...
 * 标题栏
 */
public abstract class BaseActivity extends Activity implements SingEngine.ResultListener {
    ...
    private void initEngine() {
        thread = new Thread() {
            ...
            public void run() {
                try {
                    // 1 获取引擎实例
                    engine = SingEngine.newInstance(BaseActivity.this, BaseActivity.this, null);
                    // 2. 设置引擎类型
